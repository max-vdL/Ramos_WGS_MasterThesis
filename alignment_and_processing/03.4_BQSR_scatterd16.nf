 ...
 */
params.input = "/groups/pavri/bioinfo/max/wgs/ramos_JG/Ramos_JG_d16_marked.bam"
...
process baserecalibrator {
	...
	gatk BaseRecalibrator \
		...
		-L !{interval} \
		-O "recal_data_d16_!{interval}.table"
	"""  
...
/*
Channel
    .fromPath("/groups/pavri/bioinfo/max/wgs/ramos_JG/tables/recal_data_d16_temp_*_of_50.interval_list_test.table")
    .into { tables_ch }
...
process prep {
    ...
    input:
    val filename from "/groups/pavri/bioinfo/max/wgs/ramos_JG/tables/recal_data_d16_temp_*_of_50.interval_list_test.table"
